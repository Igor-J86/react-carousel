...
export const ArrowLeft:React.FC<iconprops> = ({ width, color }) => {
  return(
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" width={width ? width : defaultWidth} fill={color && color} className={!color ? defaultColor : ''}>
...
export const ArrowRight:React.FC<iconprops> = ({ width, color }) => {
  return(
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" width={width ? width : defaultWidth} fill={color && color} className={!color ? defaultColor : ''}>
